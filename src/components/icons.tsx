...
export const VerifiedIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="10" cy="10" r="10" fill="#329AF5"/>
      <path d="M6 10.5L9 13.5L14.5 7" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const SendIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg 
    ...
    className={`h-5 w-5 -rotate-90 ${className}`}
    viewBox="0 0 20 20"
    fill="currentColor" 
  >
